-- Задание 3.1: Добавление столбца с длительностью сессии
ALTER TABLE server_logs ADD COLUMN Session_Dur REAL;

UPDATE server_logs 
SET Session_Dur = (
    julianday(Session_End) - julianday(Session_Start)
) * 24 * 60; -- Преобразование разницы в днях в минуты

-- Задание 3.2: Создание представления об активности пользователей
